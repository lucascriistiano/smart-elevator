...
extern void ElevatorController__elev_query_direction(int32_t ee, Elevator_ctx__DIRECTION *dir);
extern void ElevatorController__elev_calc_direction(int32_t orig_floor, int32_t dest_floor, Elevator_ctx__DIRECTION *dir);
